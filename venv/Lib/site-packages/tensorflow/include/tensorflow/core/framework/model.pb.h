...
constexpr AutotuneAlgorithm AutotuneAlgorithm_MAX = MAX_PARALLELISM;
...
public:
  ...
  ModelProto_NodesEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensorflow_2fcore_2fframework_2fmodel_2eproto);
    return ::descriptor_table_tensorflow_2fcore_2fframework_2fmodel_2eproto.file_level_metadata[2];
  }
